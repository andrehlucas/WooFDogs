...
const cityData = getCityPageData("dog-training-loxahatchee")!;

export const metadata: Metadata = {
  title: cityData.metaTitle,
  description: cityData.metaDescription,
  alternates: {
    canonical: "https://woofdogs.com/dog-training-loxahatchee",
  },
  openGraph: {
    title: cityData.metaTitle,
    description: cityData.metaDescription,
    url: "https://woofdogs.com/dog-training-loxahatchee",
    siteName: "WooF Dogs",
    locale: "en_US",
    type: "website",
  },
...
export default function DogTrainingLoxahatcheePage() {
  return (
    <>
