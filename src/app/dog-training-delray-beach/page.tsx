...
const cityData = getCityPageData("dog-training-delray-beach")!;

export const metadata: Metadata = {
  title: cityData.metaTitle,
  description: cityData.metaDescription,
  alternates: {
    canonical: "https://woofdogs.com/dog-training-delray-beach",
  },
  openGraph: {
    title: cityData.metaTitle,
    description: cityData.metaDescription,
    url: "https://woofdogs.com/dog-training-delray-beach",
    siteName: "WooF Dogs",
    locale: "en_US",
    type: "website",
  },
...
export default function DogTrainingDelrayBeachPage() {
  return (
    <>
