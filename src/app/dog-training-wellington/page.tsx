...
const cityData = getCityPageData("dog-training-wellington")!;

export const metadata: Metadata = {
  title: cityData.metaTitle,
  description: cityData.metaDescription,
  alternates: {
    canonical: "https://woofdogs.com/dog-training-wellington",
  },
  openGraph: {
    title: cityData.metaTitle,
    description: cityData.metaDescription,
    url: "https://woofdogs.com/dog-training-wellington",
    siteName: "WooF Dogs",
    locale: "en_US",
    type: "website",
  },
...
export default function DogTrainingWellingtonPage() {
  return (
    <>
