...
const cityData = getCityPageData("dog-training-west-palm-beach")!;

export const metadata: Metadata = {
  title: cityData.metaTitle,
  description: cityData.metaDescription,
  alternates: {
    canonical: "https://woofdogs.com/dog-training-west-palm-beach",
  },
  openGraph: {
    title: cityData.metaTitle,
    description: cityData.metaDescription,
    url: "https://woofdogs.com/dog-training-west-palm-beach",
    siteName: "WooF Dogs",
    locale: "en_US",
    type: "website",
  },
...
export default function DogTrainingWestPalmBeachPage() {
  return (
    <>
